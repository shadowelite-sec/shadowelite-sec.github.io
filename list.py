...
<body style="background-color: #0C0705;">
    <h2>Index of ${header}</h2>
    <p>
    <table>
        <tbody>
            <tr>
                <th style="color: #8E44AD" valign="top">My Files</th>
                <th><a style="color:yellow" href="?C=N;O=D">Name</a></th>
                <th><a style="color:yellow" href="?C=M;O=A">Last modified</a></th>
                <th><a style="color:yellow" href="?C=S;O=A">Size</a></th>
                <th><a style="color:yellow" href="?C=D;O=A">Description</a></th>
            </tr>
            <tr>
                <th colspan="5"><hr></th>
            </tr>
            ...
            <tr>
                ...
                <td style="color:red" align="right">${time}</td>
            ...
            <tr>
                <td valign="top"><img src="data:image/png;base64, "
                    alt="[DIR]"></td>
                <td><a style="color: #28B463" href="${name}">${name}</a></td>
                <td style="color:red" align="right">${time}</td>
                <td style="color:red" align="right">-</td>
                <td &nbsp;</td>
            </tr>
